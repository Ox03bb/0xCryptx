...
string polybius::encrypt(std::string raw, vector<vector<char>> arr, const char* x_key, const char* y_key){
	string enc;
...
string polybius::decrypt(std::string raw, vector<vector<char>> arr, const char* x_key, const char* y_key){
	string dec;
